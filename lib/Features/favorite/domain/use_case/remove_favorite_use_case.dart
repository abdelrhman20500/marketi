...
class RemoveFavoriteUseCase extends BaseUseCase<AddOrRemoveFavoriteModel, String>{
  final FavoriteRepo favoriteRepo;

  RemoveFavoriteUseCase(this.favoriteRepo);
  @override
  Future<Either<Failure, AddOrRemoveFavoriteModel>> call([String? id])async{
    return await favoriteRepo.removeFavorite(productId: id!);
  }
