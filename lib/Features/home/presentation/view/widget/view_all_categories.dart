...
import 'package:marketi/Features/home/presentation/view/widget/category_or_brand_grid_view.dart';
      ...
      body: CustomScrollView(
        ...
        slivers: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("All Categories",style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600),),
                  SizedBox(height: height * 0.02),
                ],
              ),
            ),
          ...
          const SliverPadding(
            ...
            sliver: CategoryOrBrandGridView(),
          ),
        ],
      ),
    );
