...
class ViewAllBuyAgain extends StatelessWidget {
  const ViewAllBuyAgain({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Buy Again",style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600),),
        centerTitle: true,
        actions: const [
          Padding(
