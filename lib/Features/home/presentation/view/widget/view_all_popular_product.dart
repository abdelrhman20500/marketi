...
class ViewAllPopularProduct extends StatelessWidget {
  const ViewAllPopularProduct({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Popular Product",style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600),),
        centerTitle: true,
        actions: const [
          Padding(
